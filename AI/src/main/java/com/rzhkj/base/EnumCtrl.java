...
import com.rzhkj.core.annotation.Ignore;
...
public class EnumCtrl {
     ...
     */
    private enum Enums {
        ProjectStateEnum(1000, com.rzhkj.project.entity.ProjectStateEnum.class)/*项目状态*/,
        ProjectSqlStateEnum(1001, com.rzhkj.project.entity.ProjectSqlStateEnum.class)/*项目sql状态*/,
        ProjectRepositoryTypeEnum(1002, com.rzhkj.project.entity.ProjectRepositoryTypeEnum.class)/*仓库类型*/,
        ProjectRepositoryAccountStateEnum(1003, com.rzhkj.project.entity.ProjectRepositoryAccountStateEnum.class)/*项目仓库状态*/,
        ProjectJobStateEnum(1004, com.rzhkj.project.entity.ProjectJobStateEnum.class)/*任务状态*/,
        FrameworksStateEnum(1005, com.rzhkj.project.entity.FrameworksStateEnum.class)/*模板状态*/,
        FileTypeEnum(1006, com.rzhkj.project.entity.FileTypeEnum.class)/*文件类型*/,
        DisplayAttributeEnum(1007, com.rzhkj.project.entity.DisplayAttributeEnum.class)/*显示属性*/,
        YNEnum(1101, com.rzhkj.core.enums.YNEnum.class)/*是否*/,
        SexEnum(1102, com.rzhkj.core.enums.SexEnum.class)/*性别枚举*/,
        OperateEnum(1103, com.rzhkj.core.enums.OperateEnum.class)/*操作名称定义*/,
        ModuleEnum(1104, com.rzhkj.core.enums.ModuleEnum.class)/*模块定义*/,
