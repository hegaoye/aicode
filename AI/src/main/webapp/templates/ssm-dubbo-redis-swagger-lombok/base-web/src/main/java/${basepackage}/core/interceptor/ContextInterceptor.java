...
package com.ponddy.core.interceptor;

import com.alibaba.fastjson.JSON;
import com.ponddy.core.base.BaseCtrl;
import com.ponddy.core.entity.BeanRet;
import com.ponddy.core.tools.CookieTools;
import com.ponddy.core.tools.security.Md5;
...
//            if (com.alibaba.dubbo.common.utils.StringUtils.isNotEmpty(params)
//                    && (request.getMethod().equalsIgnoreCase("post")
//                    || request.getMethod().equalsIgnoreCase("put"))) {
//                String tokenKey = "token-" + Md5.md5(request.getRequestURI());
//                String token = Md5.md5(params);
//                String cookieToken = CookieTools.INSTANCE.getCode(tokenKey);
//                if (cookieToken != null && cookieToken.equals(token)) {
//                    return false;
//                } else {
//                    CookieTools.INSTANCE.setCodeMins(tokenKey, token, 2, response);
//                }
//            }
        } catch (Exception e) {
            e.printStackTrace();
