package com.rzhkj.core.framework;

import com.rzhkj.core.framework.model.Column;
import com.rzhkj.core.framework.model.Table;
...
public class DbModelProvider {
     ...
     */
    private final static Logger logger = LoggerFactory.getLogger(DbModelProvider.class);
    ...
    private void retriveTableColumns(Table table) throws SQLException {
        logger.debug("-------setColumns(" + table.getSqlName() + ")");
    ...
    private List getTableColumns(Table table, List primaryKeys, List indices, Map uniqueIndices, Map uniqueColumns) throws SQLException {
        ...
        while (columnRs.next()) {
            ...
            if (isUnique) {
                logger.debug("unique column:" + columnName);
            }
