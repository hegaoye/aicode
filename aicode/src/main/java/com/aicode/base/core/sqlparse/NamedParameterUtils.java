...
package com.aicode.base.core.sqlparse;
...
public abstract class NamedParameterUtils {
        ...
        while (i < statement.length) {
            ...
            if (c == ':' || c == '&' || c == '#' || c == '$') {
                ...
                if (j - i > 1) {
                    ...
                    String removedPrefixAndSuffixParameter = removePrefixAndSuffix(c, parameter, sql); //add by Lixin
    ...
    //add by Lixin,增加是否需要强制要有#后缀用于ibatis2
