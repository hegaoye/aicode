package com.aicode.cache.service;
...
public class RedisServiceSVImpl {
    ...
    public RedisServiceSVImpl(RedisTemplate<String, Object> redisTemplate) {
     ...
     */
    public boolean putForHash(String key, Map<String, Object> map) {
        try {
     ...
     * @return true成功 false失败
     */
    public boolean putForHash(String key, Map<String, Object> map, long time) {
        try {
            redisTemplate.opsForHash().putAll(key, map);
            if (time > 0) {
                expire(key, time);
     ...
     */
    public boolean putForHash(String key, String item, Object value) {
        try {
     ...
     * @return true 成功 false失败
     */
    public boolean putForHash(String key, String item, Object value, long time) {
        try {
            redisTemplate.opsForHash().put(key, item, value);
            if (time > 0) {
                expire(key, time);
     ...
     * @return
     */
    public double decrementForHash(String key, String item, double num) {
     ...
     */
    public boolean addToSetForSort(String key, Object member, double score, long time) {
        try {
     ...
     * 通过分数返回有序集合指定区间内的成员
     */
    public Set<Object> getSetSortRangeByScore(String key, double minScore, double maxScore) {
        try {
     ...
     * 返回有序集中，成员的分数值
     */
    public Double getSetSortScore(String key, Object member) {
        try {
     ...
     */
    public Long getSetSortIndex(String key, Object member) {
        try {
     ...
     */
    public Cursor<ZSetOperations.TypedTuple<Object>> scanSet(String key) {
        try {
