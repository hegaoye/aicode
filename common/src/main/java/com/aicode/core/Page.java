 ...
 */
@Data
public final class Page<E> implements java.io.Serializable {
    /**
     * 全局分页大小定义
     */
    ...
    public Map<String, Object> genSqlmapParams() {
        if (sortColumns == null || sortColumns.trim().equalsIgnoreCase("") || sortColumns.trim()
