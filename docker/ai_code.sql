...
(
  ...
  COLLATE = utf8mb4_general_ci COMMENT = '账户'
  ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `account`
VALUES (1, '21218cca77804d2ba1', 'lixin', '21218cca77804d2ba1922c33e0151105');
INSERT INTO `account`
VALUES (2, '21218cca77804d2ba2', 'admin', '21218cca77804d2ba1922c33e0151105');
INSERT INTO `account`
VALUES (3, '21218cca77804d2ba2', 'aicode', '21218cca77804d2ba1922c33e0151105');
...
(
  ...
  AUTO_INCREMENT = 559
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '显示属性'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 28
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '框架技术池'
  ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of frameworks
-- ----------------------------
INSERT INTO frameworks (id, code, name, description, gitHome, account, password, isPublic)
VALUES (1, '1882812765213425664', 'springboot2.1.6-mybatisplus-redis-provider',
        '此框架以springcloud Greenwich.RELEASE，springboot 2.1.6.RELEASE 版本为基础进行整合，整合 springcloud的各个组件eureka,feign，mybatisplus,hutool实现分布式微服务',
        'https://github.com/hegaoye/aicode-template.git', 'hegaoye@qq.com', '888888', 'Y');
INSERT INTO frameworks (id, code, name, description, gitHome, account, password, isPublic)
VALUES (2, '1081629222214967291', 'ssm-dubbo-redis-swagger-lombok-disconf-sentry',
        '此项目整合了ssm+dubbo+redis+swagger+lombok几大框架便于实现分布式，采用gradle管理构建项目，lombok使用请安装ide的插件并进行设置即可完成javabean的简化',
        'https://gitee.com/helixin/aicode_template.git', 'hegaoye@qq.com', '888888', 'Y');
INSERT INTO frameworks (id, code, name, description, gitHome, account, password, isPublic)
VALUES (3, '1081629222214967292', 'ssh+redis+swagger+lombok', 'ssh+redis+swagger+lombok',
        'https://gitee.com/helixin/aicode_template.git', 'hegaoye@qq.com', '888888', 'Y');
INSERT INTO frameworks (id, code, name, description, gitHome, account, password, isPublic)
VALUES (4, '1081629222214967293', 'spring-cloud-redis-lombok-sentry',
        '此框架整合了spring-cloud、redis、lombok，swagger等最新版本，可以方便的实现单项目开发，分布式开发的需求；需要注意的是需要对spring boot有所了解将有助于使用此套框架，框架自己包含了工具包，配置好了分层，需要修改数据库连接地址以及一些自己内网的信息接口生成后直接运行使用，免测试。',
        'https://gitee.com/helixin/aicode_template.git', 'hegaoye@qq.com', '888888', 'Y');
INSERT INTO frameworks (id, code, name, description, gitHome, account, password, isPublic)
VALUES (5, '1081629222214967294', 'ssm-redis-swagger-lombok-pitop', 'ssm+redis+swagger+lombok',
        'https://gitee.com/helixin/aicode_template.git', 'hegaoye@qq.com', '888888', 'Y');
INSERT INTO frameworks (id, code, name, description, gitHome, account, password, isPublic)
VALUES (6, '1081629222214967295', 'springboot-redis-swagger-lombok', 'springboot+redis+swagger+lombok',
        'https://gitee.com/helixin/aicode_template.git', 'hegaoye@qq.com', '888888', 'Y');
INSERT INTO frameworks (id, code, name, description, gitHome, account, password, isPublic)
VALUES (7, '1081629222214967296', 'angular-template', 'angular 框架自动与后端接口对接，请配合使用以frontend结尾的后端框架生成使用',
        'https://gitee.com/helixin/aicode_template.git', 'hegaoye@qq.com', '888888', 'Y');
INSERT INTO frameworks (id, code, name, description, gitHome, account, password, isPublic)
VALUES (8, '1081629222214967297', 'springboot-redis-swagger-lombok-frontend',
        'springboot-redis-swagger-lombok-frontend', 'https://gitee.com/helixin/aicode_template.git', 'hegaoye@qq.com',
        '888888', 'Y');
INSERT INTO frameworks (id, code, name, description, gitHome, account, password, isPublic)
VALUES (9, '1081629222214967298', 'angular-template-i18n', 'angular国际化模板',
        'https://gitee.com/helixin/aicode_template.git', 'hegaoye@qq.com', '888888', 'Y');
INSERT INTO frameworks (id, code, name, description, gitHome, account, password, isPublic)
VALUES (10, '1081629222214967299', 'springcloud2.1.5-redis-swagger-lombok-provider',
        '此框架以springcloud Greenwich.RELEASE，springboot 2.1.5.RELEASE 版本为基础进行整合，整合 springcloud的各个组件eureka,feign 实现分布式微服务',
        'https://gitee.com/helixin/aicode_template.git', 'hegaoye@qq.com', '888888', 'Y');
INSERT INTO frameworks (id, code, name, description, gitHome, account, password, isPublic)
VALUES (11, '1593730370629427201', 'springcloud2.1.5-provider-config',
        '此框架以springcloud Greenwich.RELEASE，springboot 2.1.5.RELEASE 版本为基础进行整合，整合 springcloud的各个组件eureka,feign,config 实现分布式微服务',
        'https://gitee.com/helixin/aicode_template.git', 'hegaoye@qq.com', '888888', 'Y');
INSERT INTO frameworks (id, code, name, description, gitHome, account, password, isPublic)
VALUES (12, '1593730370629427202', 'springboot-redis-swagger-lombok-aoplog-jwt',
        'Spring cloud + Mybatis + Redis + Swagger + Lombok 基础框架组合 + 自定义 AOP 日志 + JWT 登录验证',
        'https://gitee.com/helixin/aicode_template.git', 'hegaoye@qq.com', '888888', 'Y');
INSERT INTO frameworks (id, code, name, description, gitHome, account, password, isPublic)
VALUES (13, '1593730370629427203', 'ssh-redis-swagger-lombok', '整合springmvc,spring,hibernate,swagger,redis,lombok等多种框架',
        'https://gitee.com/helixin/aicode_template.git', 'hegaoye@qq.com', '888888', 'Y');
INSERT INTO frameworks (id, code, name, description, gitHome, account, password, isPublic)
VALUES (14, '1593730370629427204', 'angular-template-rzhkj', 'angular 框架自动与后端接口对接，请配合使用以frontend结尾的后端框架生成使用',
        'https://gitee.com/helixin/aicode_template.git', 'hegaoye@qq.com', '888888', 'Y');
INSERT INTO frameworks (id, code, name, description, gitHome, account, password, isPublic)
VALUES (15, '1593730370629427205', 'springboot-redis-swagger-lombok-rzhkj',
        'rzhkj springboot 版本框架整合了redis,swagger,lombok等', 'https://gitee.com/helixin/aicode_template.git',
        'hegaoye@qq.com', '888888', 'Y');
INSERT INTO frameworks (id, code, name, description, gitHome, account, password, isPublic)
VALUES (16, '1081629222214967290', 'ssm-redis-swagger-lombok', 'ssm+redis+swagger+lombok',
        'https://gitee.com/helixin/aicode_template.git', 'hegaoye@qq.com', '888888', 'Y');
INSERT INTO frameworks (id, code, name, description, gitHome, account, password, isPublic)
VALUES (17, '1884742476840075264', 'springboot2.1.6-mybatisplus-redis-rocketmq',
        '此框架以springcloud Greenwich.RELEASE，springboot 2.1.6.RELEASE 版本为基础进行整合，整合 springcloud的各个组件eureka,feign，mybatisplus,hutool实现分布式微服务',
        'https://github.com/hegaoye/aicode-template.git', 'hegaoye@qq.com', '888888', 'Y');
INSERT INTO frameworks (id, code, name, description, gitHome, account, password, isPublic)
VALUES (18, '1886058987395538944', 'springboot2.1.6-mybatisplus-mongodb-redis-rocketmq',
        '此框架以springcloud Greenwich.RELEASE，springboot 2.1.6.RELEASE 版本为基础进行整合，整合 springcloud的各个组件eureka,feign，mybatisplus,mongodb,redis,hutool实现分布式微服务',
        'https://github.com/hegaoye/aicode-template.git', 'hegaoye@qq.com', '888888', 'Y');
INSERT INTO frameworks (id, code, name, description, gitHome, account, password, isPublic)
VALUES (19, '1887714594208948224', 'springboot2.1.6-mybatisplus-redis',
        '整合springboot2.1.6,以及cloud组件feign,mybatisplus,redis主要用于分布式系统中的 ctrl层，用于整合provider层使用，且swagger访问时可以返回R 对象，封装的统一返回类型',
        'https://github.com/hegaoye/aicode-template.git', 'hegaoye@qq.com', '888888', 'Y');
INSERT INTO frameworks (id, code, name, description, gitHome, account, password, isPublic)
VALUES (20, '1887715178324500480', 'springboot2.1.6-mybatisplus-mongodb-redis-rabbitmq',
        '整合springboot2.1.6,以及cloud组件feign,mybatisplus,mongodb,redis,rabbitmq,主要用于分布式系统中的 provider层，此时ctrl层仅仅返回实际结果不会被包装为BeanRet的对象',
        'https://github.com/hegaoye/aicode-template.git', 'hegaoye@qq.com', '888888', 'Y');
INSERT INTO frameworks (id, code, name, description, gitHome, account, password, isPublic)
VALUES (21, '1887715590641360896', 'springboot2.1.6-mybatisplus-mongodb-redis-kafka',
        '整合springboot2.1.6,以及cloud组件feign,mybatisplus,mongodb,redis,kafka,主要用于分布式系统中的 provider层，此时ctrl层仅仅返回实际结果不会被包装为BeanRet的对象',
        'https://github.com/hegaoye/aicode-template.git', 'hegaoye@qq.com', '888888', 'Y');
INSERT INTO frameworks (id, code, name, description, gitHome, account, password, isPublic)
VALUES (22, '1887716621433511936', 'springboot2.1.6-mysql-mongo-redis-rocketmq-dubbo',
        '整合springboot2.1.6,以及cloud组件feign,mybatisplus,mongodb,redis,rocketmq,dubbo,主要用于分布式系统中的 provider层，此时ctrl层仅仅返回实际结果不会被包装为BeanRet的对象',
        'https://github.com/hegaoye/aicode-template.git', 'hegaoye@qq.com', '888888', 'Y');
INSERT INTO frameworks (id, code, name, description, gitHome, account, password, isPublic)
VALUES (23, '2079202962321588224', 'springboot2.2.6-mybatisplus-redis-ignite-rocketmq',
        '整合springboot2.1.6,以及cloud组件feign,mybatisplus,redis,rocketmq,ignite,主要用于分布式系统中的 provider层，此时ctrl层仅仅返回实际结果不会被包装为BeanRet的对象',
        'https://github.com/hegaoye/aicode-template.git', 'hegaoye@qq.com', '888888', 'Y');
INSERT INTO frameworks (id, code, name, description, gitHome, account, password, isPublic)
VALUES (24, '2080258063987564544', 'springboot2.2.6-mybatisplus-redis-rocketmq',
        '整合springboot2.1.6,以及cloud组件feign,mybatisplus,redis,rocketmq,mysql,主要用于分布式系统中的 provider层，此时ctrl层仅仅返回实际结果不会被包装为BeanRet的对象',
        'https://github.com/hegaoye/aicode-template.git', 'hegaoye@qq.com', '888888', 'Y');
INSERT INTO frameworks (id, code, name, description, gitHome, account, password, isPublic)
VALUES (25, '2080258063987564555', 'springboot2.2.6-mybatisplus-redis',
        '整合springboot2.1.6,以及cloud组件feign,mybatisplus,redis,mysql,主要用于分布式系统中的 provider层，此时ctrl层仅仅返回实际结果不会被包装为BeanRet的对象',
        'https://github.com/hegaoye/aicode-template.git', 'hegaoye@qq.com', '888888', 'Y');
INSERT INTO frameworks (id, code, name, description, gitHome, account, password, isPublic)
VALUES (26, '2080258063987564556', 'springboot2.2.6-mybatisplus-redis-gateway',
...
(
  ...
  AUTO_INCREMENT = 205745
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '框架配置文件模板'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 1441
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '类表映射信息'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 12181
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '字段属性映射信息'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 236
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '模型关系'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 2
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '第三方模块池'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 1
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '模块文件信息'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 1
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '生成源码资料'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 241
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '项目应用技术'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 1442
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '项目数据表'
  ROW_FORMAT = Dynamic;
...
(
  ...
  COLLATE = latin1_swedish_ci COMMENT = '模块'
  ROW_FORMAT = Dynamic;
...
(
  ...
  CHARACTER SET = latin1
  COLLATE = latin1_swedish_ci COMMENT = '模块下的类'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 1
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '项目选择模块'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 136
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '版本控制管理'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 193
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '项目sql脚本'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 9
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '设置'
  ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `setting`
VALUES (1, 'DefaultDatabase', 'ai_code', '默认链接数据库');
INSERT INTO `setting`
VALUES (2, 'Gradle_Directory_Structure', '[\"src/main/java\",\"src/main/resources/framework\"]', 'gradle目录结构');
INSERT INTO `setting`
VALUES (3, 'Workspace', '/static/workspace/', '工作目录');
INSERT INTO `setting`
VALUES (4, 'Package_entity', 'po', '实体目录命名');
INSERT INTO `setting`
VALUES (5, 'Template_Path', '/static/templates/', '模板默认路径');
INSERT INTO `setting`
VALUES (6, 'Repository_Path', '/static/repository/', 'zip仓库');
INSERT INTO `setting`
VALUES (7, 'GitHome_Default', 'https://gitee.com/helixin/aicode_template.git', '默认系统模板仓库路径');
INSERT INTO `setting`
VALUES (8, 'SandBox_Path', '/sandbox/', '沙箱环境目录');
...
(
  ...
  AUTO_INCREMENT = 2285
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = 'DB WorkerID Assigner for UID Generator'
  ROW_FORMAT = Dynamic;
