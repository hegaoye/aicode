...
INSERT INTO `frameworks` (`id`, `code`, `name`, `description`, `gitHome`, `account`, `password`, `isPublic`) VALUES (28, '1081629222214967290', 'ssm-redis-swagger-lombok', 'ssm+redis+swagger+lombok', 'https://gitee.com/helixin/aicode_template.git', 'hegaoye@qq.com', '888888', 'Y');
INSERT INTO `frameworks` (`id`, `code`, `name`, `description`, `gitHome`, `account`, `password`, `isPublic`) VALUES (30, '1884742476840075264', 'springboot2.1.6-mybatisplus-redis-rocketmq', '此框架以springcloud Greenwich.RELEASE，springboot 2.1.6.RELEASE 版本为基础进行整合，整合 springcloud的各个组件eureka,feign，mybatisplus,hutool实现分布式微服务', 'https://github.com/hegaoye/aicode-template.git', 'hegaoye@qq.com', '888888', 'Y');
INSERT INTO `frameworks` (`id`, `code`, `name`, `description`, `gitHome`, `account`, `password`, `isPublic`) VALUES (31, '1886058987395538944', 'springboot2.1.6-mybatisplus-mongodb-redis-rocketmq', '此框架以springcloud Greenwich.RELEASE，springboot 2.1.6.RELEASE 版本为基础进行整合，整合 springcloud的各个组件eureka,feign，mybatisplus,mongodb,redis,hutool实现分布式微服务', 'https://github.com/hegaoye/aicode-template.git', 'hegaoye@qq.com', '888888', 'Y');
INSERT INTO `frameworks` (`id`, `code`, `name`, `description`, `gitHome`, `account`, `password`, `isPublic`) VALUES (32, '1887714594208948224', 'springboot2.1.6-mybatisplus-redis', '整合springboot2.1.6,以及cloud组件feign,mybatisplus,redis主要用于分布式系统中的 ctrl层，用于整合provider层使用，且swagger访问时可以返回R 对象，封装的统一返回类型', 'https://github.com/hegaoye/aicode-template.git', 'hegaoye@qq.com', '888888', 'Y');
INSERT INTO `frameworks` (`id`, `code`, `name`, `description`, `gitHome`, `account`, `password`, `isPublic`) VALUES (33, '1887715178324500480', 'springboot2.1.6-mybatisplus-mongodb-redis-rabbitmq', '整合springboot2.1.6,以及cloud组件feign,mybatisplus,mongodb,redis,rabbitmq,主要用于分布式系统中的 provider层，此时ctrl层仅仅返回实际结果不会被包装为BeanRet的对象', 'https://github.com/hegaoye/aicode-template.git', 'hegaoye@qq.com', '888888', 'Y');
INSERT INTO `frameworks` (`id`, `code`, `name`, `description`, `gitHome`, `account`, `password`, `isPublic`) VALUES (34, '1887715590641360896', 'springboot2.1.6-mybatisplus-mongodb-redis-kafka', '整合springboot2.1.6,以及cloud组件feign,mybatisplus,mongodb,redis,kafka,主要用于分布式系统中的 provider层，此时ctrl层仅仅返回实际结果不会被包装为BeanRet的对象', 'https://github.com/hegaoye/aicode-template.git', 'hegaoye@qq.com', '888888', 'Y');
INSERT INTO `frameworks` (`id`, `code`, `name`, `description`, `gitHome`, `account`, `password`, `isPublic`) VALUES (35, '1887716621433511936', 'springboot2.1.6-mysql-mongo-redis-rocketmq-dubbo', '整合springboot2.1.6,以及cloud组件feign,mybatisplus,mongodb,redis,rocketmq,dubbo,主要用于分布式系统中的 provider层，此时ctrl层仅仅返回实际结果不会被包装为BeanRet的对象', 'https://github.com/hegaoye/aicode-template.git', 'hegaoye@qq.com', '888888', 'Y');
