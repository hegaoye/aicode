...
INSERT INTO frameworks (id, code, name, description, gitHome, account, password, isPublic) VALUES (30, '2080258063987564560', 'springcloud3.1.1-mybatisplus-redis-rocketmq-java17', '整合springboot3.1.1,java17+,以及cloud组件feign,mybatisplus,redis,rocketmq,springdoc', 'https://github.com/hegaoye/aicode-template.git', 'hegaoye@qq.com', '888888', 'Y');
