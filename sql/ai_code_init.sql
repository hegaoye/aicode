...
-- ----------------------------
INSERT INTO ai_code.frameworks (id, code, name, description, gitHome, account, password, isPublic) VALUES (1, '1882812765213425664', 'springboot2.1.6-mybatisplus-redis-provider', '此框架以springcloud Greenwich.RELEASE，springboot 2.1.6.RELEASE 版本为基础进行整合，整合 springcloud的各个组件eureka,feign，mybatisplus,hutool实现分布式微服务', 'https://github.com/hegaoye/aicode-template.git', 'hegaoye@qq.com', '888888', 'Y');
INSERT INTO ai_code.frameworks (id, code, name, description, gitHome, account, password, isPublic) VALUES (2, '1081629222214967291', 'ssm-dubbo-redis-swagger-lombok-disconf-sentry', '此项目整合了ssm+dubbo+redis+swagger+lombok几大框架便于实现分布式，采用gradle管理构建项目，lombok使用请安装ide的插件并进行设置即可完成javabean的简化', 'https://gitee.com/helixin/aicode_template.git', 'hegaoye@qq.com', '888888', 'Y');
INSERT INTO ai_code.frameworks (id, code, name, description, gitHome, account, password, isPublic) VALUES (3, '1081629222214967292', 'ssh+redis+swagger+lombok', 'ssh+redis+swagger+lombok', 'https://gitee.com/helixin/aicode_template.git', 'hegaoye@qq.com', '888888', 'Y');
INSERT INTO ai_code.frameworks (id, code, name, description, gitHome, account, password, isPublic) VALUES (4, '1081629222214967293', 'spring-cloud-redis-lombok-sentry', '此框架整合了spring-cloud、redis、lombok，swagger等最新版本，可以方便的实现单项目开发，分布式开发的需求；需要注意的是需要对spring boot有所了解将有助于使用此套框架，框架自己包含了工具包，配置好了分层，需要修改数据库连接地址以及一些自己内网的信息接口生成后直接运行使用，免测试。', 'https://gitee.com/helixin/aicode_template.git', 'hegaoye@qq.com', '888888', 'Y');
INSERT INTO ai_code.frameworks (id, code, name, description, gitHome, account, password, isPublic) VALUES (5, '1081629222214967294', 'ssm-redis-swagger-lombok-pitop', 'ssm+redis+swagger+lombok', 'https://gitee.com/helixin/aicode_template.git', 'hegaoye@qq.com', '888888', 'Y');
INSERT INTO ai_code.frameworks (id, code, name, description, gitHome, account, password, isPublic) VALUES (6, '1081629222214967295', 'springboot-redis-swagger-lombok', 'springboot+redis+swagger+lombok', 'https://gitee.com/helixin/aicode_template.git', 'hegaoye@qq.com', '888888', 'Y');
INSERT INTO ai_code.frameworks (id, code, name, description, gitHome, account, password, isPublic) VALUES (7, '1081629222214967296', 'angular-template', 'angular 框架自动与后端接口对接，请配合使用以frontend结尾的后端框架生成使用', 'https://gitee.com/helixin/aicode_template.git', 'hegaoye@qq.com', '888888', 'Y');
INSERT INTO ai_code.frameworks (id, code, name, description, gitHome, account, password, isPublic) VALUES (8, '1081629222214967297', 'springboot-redis-swagger-lombok-frontend', 'springboot-redis-swagger-lombok-frontend', 'https://gitee.com/helixin/aicode_template.git', 'hegaoye@qq.com', '888888', 'Y');
INSERT INTO ai_code.frameworks (id, code, name, description, gitHome, account, password, isPublic) VALUES (9, '1081629222214967298', 'angular-template-i18n', 'angular国际化模板', 'https://gitee.com/helixin/aicode_template.git', 'hegaoye@qq.com', '888888', 'Y');
INSERT INTO ai_code.frameworks (id, code, name, description, gitHome, account, password, isPublic) VALUES (10, '1081629222214967299', 'springcloud2.1.5-redis-swagger-lombok-provider', '此框架以springcloud Greenwich.RELEASE，springboot 2.1.5.RELEASE 版本为基础进行整合，整合 springcloud的各个组件eureka,feign 实现分布式微服务', 'https://gitee.com/helixin/aicode_template.git', 'hegaoye@qq.com', '888888', 'Y');
INSERT INTO ai_code.frameworks (id, code, name, description, gitHome, account, password, isPublic) VALUES (11, '1593730370629427201', 'springcloud2.1.5-provider-config', '此框架以springcloud Greenwich.RELEASE，springboot 2.1.5.RELEASE 版本为基础进行整合，整合 springcloud的各个组件eureka,feign,config 实现分布式微服务', 'https://gitee.com/helixin/aicode_template.git', 'hegaoye@qq.com', '888888', 'Y');
INSERT INTO ai_code.frameworks (id, code, name, description, gitHome, account, password, isPublic) VALUES (12, '1593730370629427202', 'springboot-redis-swagger-lombok-aoplog-jwt', 'Spring cloud + Mybatis + Redis + Swagger + Lombok 基础框架组合 + 自定义 AOP 日志 + JWT 登录验证', 'https://gitee.com/helixin/aicode_template.git', 'hegaoye@qq.com', '888888', 'Y');
INSERT INTO ai_code.frameworks (id, code, name, description, gitHome, account, password, isPublic) VALUES (13, '1593730370629427203', 'ssh-redis-swagger-lombok', '整合springmvc,spring,hibernate,swagger,redis,lombok等多种框架', 'https://gitee.com/helixin/aicode_template.git', 'hegaoye@qq.com', '888888', 'Y');
INSERT INTO ai_code.frameworks (id, code, name, description, gitHome, account, password, isPublic) VALUES (14, '1593730370629427204', 'angular-template-rzhkj', 'angular 框架自动与后端接口对接，请配合使用以frontend结尾的后端框架生成使用', 'https://gitee.com/helixin/aicode_template.git', 'hegaoye@qq.com', '888888', 'Y');
INSERT INTO ai_code.frameworks (id, code, name, description, gitHome, account, password, isPublic) VALUES (15, '1593730370629427205', 'springboot-redis-swagger-lombok-rzhkj', 'rzhkj springboot 版本框架整合了redis,swagger,lombok等', 'https://gitee.com/helixin/aicode_template.git', 'hegaoye@qq.com', '888888', 'Y');
INSERT INTO ai_code.frameworks (id, code, name, description, gitHome, account, password, isPublic) VALUES (16, '1081629222214967290', 'ssm-redis-swagger-lombok', 'ssm+redis+swagger+lombok', 'https://gitee.com/helixin/aicode_template.git', 'hegaoye@qq.com', '888888', 'Y');
INSERT INTO ai_code.frameworks (id, code, name, description, gitHome, account, password, isPublic) VALUES (17, '1884742476840075264', 'springboot2.1.6-mybatisplus-redis-rocketmq', '此框架以springcloud Greenwich.RELEASE，springboot 2.1.6.RELEASE 版本为基础进行整合，整合 springcloud的各个组件eureka,feign，mybatisplus,hutool实现分布式微服务', 'https://github.com/hegaoye/aicode-template.git', 'hegaoye@qq.com', '888888', 'Y');
INSERT INTO ai_code.frameworks (id, code, name, description, gitHome, account, password, isPublic) VALUES (18, '1886058987395538944', 'springboot2.1.6-mybatisplus-mongodb-redis-rocketmq', '此框架以springcloud Greenwich.RELEASE，springboot 2.1.6.RELEASE 版本为基础进行整合，整合 springcloud的各个组件eureka,feign，mybatisplus,mongodb,redis,hutool实现分布式微服务', 'https://github.com/hegaoye/aicode-template.git', 'hegaoye@qq.com', '888888', 'Y');
INSERT INTO ai_code.frameworks (id, code, name, description, gitHome, account, password, isPublic) VALUES (19, '1887714594208948224', 'springboot2.1.6-mybatisplus-redis', '整合springboot2.1.6,以及cloud组件feign,mybatisplus,redis主要用于分布式系统中的 ctrl层，用于整合provider层使用，且swagger访问时可以返回R 对象，封装的统一返回类型', 'https://github.com/hegaoye/aicode-template.git', 'hegaoye@qq.com', '888888', 'Y');
INSERT INTO ai_code.frameworks (id, code, name, description, gitHome, account, password, isPublic) VALUES (20, '1887715178324500480', 'springboot2.1.6-mybatisplus-mongodb-redis-rabbitmq', '整合springboot2.1.6,以及cloud组件feign,mybatisplus,mongodb,redis,rabbitmq,主要用于分布式系统中的 provider层，此时ctrl层仅仅返回实际结果不会被包装为BeanRet的对象', 'https://github.com/hegaoye/aicode-template.git', 'hegaoye@qq.com', '888888', 'Y');
INSERT INTO ai_code.frameworks (id, code, name, description, gitHome, account, password, isPublic) VALUES (21, '1887715590641360896', 'springboot2.1.6-mybatisplus-mongodb-redis-kafka', '整合springboot2.1.6,以及cloud组件feign,mybatisplus,mongodb,redis,kafka,主要用于分布式系统中的 provider层，此时ctrl层仅仅返回实际结果不会被包装为BeanRet的对象', 'https://github.com/hegaoye/aicode-template.git', 'hegaoye@qq.com', '888888', 'Y');
INSERT INTO ai_code.frameworks (id, code, name, description, gitHome, account, password, isPublic) VALUES (22, '1887716621433511936', 'springboot2.1.6-mysql-mongo-redis-rocketmq-dubbo', '整合springboot2.1.6,以及cloud组件feign,mybatisplus,mongodb,redis,rocketmq,dubbo,主要用于分布式系统中的 provider层，此时ctrl层仅仅返回实际结果不会被包装为BeanRet的对象', 'https://github.com/hegaoye/aicode-template.git', 'hegaoye@qq.com', '888888', 'Y');
INSERT INTO ai_code.frameworks (id, code, name, description, gitHome, account, password, isPublic) VALUES (23, '2079202962321588224', 'springboot2.2.6-mybatisplus-redis-ignite-rocketmq', '整合springboot2.1.6,以及cloud组件feign,mybatisplus,redis,rocketmq,ignite,主要用于分布式系统中的 provider层，此时ctrl层仅仅返回实际结果不会被包装为BeanRet的对象', 'https://github.com/hegaoye/aicode-template.git', 'hegaoye@qq.com', '888888', 'Y');
INSERT INTO ai_code.frameworks (id, code, name, description, gitHome, account, password, isPublic) VALUES (24, '2080258063987564544', 'springboot2.2.6-mybatisplus-redis-rocketmq', '整合springboot2.1.6,以及cloud组件feign,mybatisplus,redis,rocketmq,mysql,主要用于分布式系统中的 provider层，此时ctrl层仅仅返回实际结果不会被包装为BeanRet的对象', 'https://github.com/hegaoye/aicode-template.git', 'hegaoye@qq.com', '888888', 'Y');
