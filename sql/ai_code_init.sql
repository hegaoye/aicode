...
INSERT INTO frameworks (id, code, name, description, gitHome, account, password, isPublic) VALUES (29, '2080258063987564559', 'aicode.json', '整合springboot3.1.1,java17+,以及cloud组件feign,mybatisplus,redis,rocketmq,springdoc', 'https://github.com/hegaoye/aicode-template.git', 'hegaoye@qq.com', '888888', 'Y');
