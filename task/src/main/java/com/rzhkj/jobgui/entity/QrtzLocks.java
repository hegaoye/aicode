 ...
 * @since 1.0
 */
public class QrtzLocks extends BaseEntity implements java.io.Serializable {
    private static final long serialVersionUID = 5454155825314635342L;

    //alias
    public static final String TABLE_ALIAS = "QrtzLocks";
    public static final String ALIAS_SCHED_NAME = "schedName";
    public static final String ALIAS_LOCK_NAME = "lockName";

    //date formats

    //可以直接使用: @Length(max=50,message="用户名长度不能大于50")显示错误消息
    private String schedName;//数据库字段:SCHED_NAME  属性显示:schedName
    private String lockName;//数据库字段:LOCK_NAME  属性显示:lockName
    ...
    public boolean equals(Object obj) {
        if (obj instanceof QrtzLocks == false) return false;
