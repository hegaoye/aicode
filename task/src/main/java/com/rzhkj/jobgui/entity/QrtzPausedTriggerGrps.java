 ...
 * @since 1.0
 */
public class QrtzPausedTriggerGrps extends BaseEntity implements java.io.Serializable {
    private static final long serialVersionUID = 5454155825314635342L;

    //alias
    public static final String TABLE_ALIAS = "QrtzPausedTriggerGrps";
    ...
    public boolean equals(Object obj) {
        if (obj instanceof QrtzPausedTriggerGrps == false) return false;
