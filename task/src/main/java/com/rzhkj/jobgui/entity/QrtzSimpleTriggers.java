 ...
 * @since 1.0
 */
public class QrtzSimpleTriggers extends BaseEntity implements java.io.Serializable {
    private static final long serialVersionUID = 5454155825314635342L;

    //alias
    public static final String TABLE_ALIAS = "QrtzSimpleTriggers";
    ...
    public static final String ALIAS_REPEAT_COUNT = "repeatCount";
    public static final String ALIAS_REPEAT_INTERVAL = "repeatInterval";
    public static final String ALIAS_TIMES_TRIGGERED = "timesTriggered";
    ...
    private Long repeatCount;//数据库字段:REPEAT_COUNT  属性显示:repeatCount
    private Long repeatInterval;//数据库字段:REPEAT_INTERVAL  属性显示:repeatInterval
    private Long timesTriggered;//数据库字段:TIMES_TRIGGERED  属性显示:timesTriggered
    ...
    public String toString() {
        return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE)
                ...
                .append("RepeatInterval", getRepeatInterval())
                .append("TimesTriggered", getTimesTriggered())
                .toString();
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof QrtzSimpleTriggers == false) return false;
