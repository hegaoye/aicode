...
public class ${className}Action extends BaseStruts2Action{
	...
	protected static final String LIST_ACTION = "!${strutsActionBasePath}/list.action";
	...
	/** 执行搜索 */
	public String list() {
		PageInfo pageInfo = newPageInfo(DEFAULT_SORT_COLUMN,DEFAULT_SORT_DIRECTION);
		Page page = ${classNameLower}Manager.findByPageInfo(pageInfo);
		savePage(page);
		return LIST_JSP;
	}
